...
<head>
    <meta charset="utf-8">
    <link rel="shortcut icon" href="/react-wp/wp-content/themes/react-wp-theme/favicon.ico">
    ...
    <!--
        ...
        Notice the use of "php echo $TEMPLATE_PATH;" and /react-wp/wp-content/themes/react-wp-theme in the tags above.
        Both will be replaced with the URL of the `public` folder during the build (/react-wp/wp-content/themes/react-wp-theme) or
        at render time (php echo $TEMPLATE_PATH;)
        Only files inside the `public` folder can be referenced like this.

        Unlike "/favicon.ico" or "favicon.ico", "/react-wp/wp-content/themes/react-wp-theme/favicon.ico" will
...
<script> wpThemeClient.start("ws", "127.0.0.1", "8090"); </script>
    ...
    -->
    <script src="/react-wp/wp-content/themes/react-wp-theme/static/js/bundle.js"></script><script src="/react-wp/wp-content/themes/react-wp-theme/static/js/0.chunk.js"></script><script src="/react-wp/wp-content/themes/react-wp-theme/static/js/main.chunk.js"></script></body>
</html>
